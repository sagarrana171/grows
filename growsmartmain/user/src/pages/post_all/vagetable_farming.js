...
function Vagetablefarming() {
 
  
 const[list, Setlist] =useState([]);

 useEffect(()=>{
Axois.get('http://localhost:1137/api/vegetable_fetch').then((response)=>{
  ...
  <Searchbar/>
         ...
         <div class="fashion_section">
                     ...
                     <div class="container">
                        <h1 class="fashion_taital"> Vegetable</h1>
...
} export default Vagetablefarming