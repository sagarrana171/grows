...
function  Manage_scheme() {
  ...
  useEffect(() => {
  Axios.get('http://localhost:1137/api/scheme_fetch',
  {
  ...
  Axios.post('http://localhost:1137/api/get_scheme_fetch',{id:id}).then((response)=>{
    ...
    <main id="main" class="main">
      ...
      <div class="row">
        ...
        {/* <div class="row"> */}
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Manage Scheme</h5>
            ...
            <div class="modal-body">
                ...
                {rs.map((val1) => {
                  ...
                  return (
                    ...
                    <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Manage Scheme</h4>
