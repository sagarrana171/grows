...
function  Manage_fertilizer() {
  ...
  Axios.post('http://localhost:1137/api/updated_fertilizer',{id:id,post_title1:post_title1,post_description1:post_description1,post_description_etc:post_description_etc,post_subtitle1:post_subtitle1,post_subdescription1:post_subdescription1}).then((response)=>{
  ...
  useEffect(() => {
  Axios.get('http://localhost:1137/api/fertilizer_fetch',
  {
  ...
  Axios.post('http://localhost:1137/api/get_fertilizer_fetch',{id:id}).then((response)=>{
    ...
    <main id="main" class="main">
      ...
      <div class="row">
        ...
        {/* <div class="row"> */}
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Manage Fertilizer</h5>
            ...
            <div class="modal-body">
                ...
                {rs.map((val1) => {
                  ...
                  return (
                    ...
                    <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Manage Fertilizer</h4>
...
} export default Manage_fertilizer;