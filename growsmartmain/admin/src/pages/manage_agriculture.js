...
const onupdate=(e) =>{
        ...
        Axios.post('http://localhost:1137/api/updated_agriculture',{id:id,post_title1:post_title1,post_description1:post_description1,post_description_etc:post_description_etc,post_subtitle1:post_subtitle1,post_subdescription1:post_subdescription1}).then((response)=>{
  ...
  <>
    ...
    <main id="main" class="main">
      ...
      <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Manage Agriculture</h5>
                  ...
                  <tbody>
                    ...
                    {list.map((val,index) => {
                      ...
                      return (
                        ...
                        <tr>
                          <td>{index+1}</td>
                          <td><input type="text" readOnly name="sutitle" value={val.post_title} style={{width:"200px"}}/></td>
                          <td><textarea rows="7" readOnly style={{width:"300px"}}>{val.post_decrisption}</textarea></td>
                          <td><input type="text" readOnly name="sutitle" value={val.post_subtitle} style={{width:"200px"}}/></td>
                          <td><textarea rows="7" readOnly style={{width:"300px"}}>{val.post_subdecrisption}</textarea></td>
            ...
            <div class="modal-body">
                ...
                {rs.map((val1) => {
                  ...
                  return (
                    ...
                    <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Manage Agriculture</h4>
