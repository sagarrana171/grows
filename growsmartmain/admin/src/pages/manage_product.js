...
Axios.post('http://localhost:1137/api/updated_product',{id:id,post_title1:post_title1,post_description1:post_description1,post_price1:post_price1}).then((response)=>{
