...
const post_price1=document.getElementById('post_price1').value;
Axios.post('http://localhost:1137/api/updated_equipment',{id:id,post_title1:post_title1,post_description1:post_description1,post_price1:post_price1}).then((response)=>{
...
Axios.post('http://localhost:1137/api/get_equipment_fetch',{id:id}).then((response)=>{
                  ...
                  <tbody>
                    ...
                    {list.map((val,index) => {
                      ...
                      return (
                        ...
                        <tr>
                          <td>{index+1}</td>
                          <td><input type="text" name="sutitle" readOnly value={val.post_title} style={{width:"400px"}}/></td>
                          <td><textarea rows="7" readOnly style={{width:"600px"}}>{val.post_decrisption}</textarea></td>
                                    ...
                                    <input type="text" value={val1._id} id="id" hidden />
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group">
                                                            ...
                                                            <input type="text" defaultValue={val1.post_price} class="form-control" id="post_price1"  />
                                                </div>
...
} export default Manage_equipment;